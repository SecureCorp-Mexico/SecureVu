...
### SecureVu Home Assistant Add-on

This repository holds the Home Assistant Add-on, for use with Home Assistant OS and compatible installations. It is the piece that allows you to run SecureVu from your Home Assistant Supervisor tab.

Fork [blakeblackshear/securevu-hass-addons](https://github.com/SecureCorp-Mexico/SecureVu-hass-addons) to your own Github profile, then clone the forked repo to your local machine.

### SecureVu Home Assistant Integration

This repository holds the custom integration that allows your Home Assistant installation to automatically create entities for your SecureVu instance, whether you are running SecureVu as a standalone Docker container or as a [Home Assistant Add-on](#securevu-home-assistant-add-on).

Fork [blakeblackshear/securevu-hass-integration](https://github.com/SecureCorp-Mexico/SecureVu-hass-integration) to your own GitHub profile, then clone the forked repo to your local machine.
...
- Do not make large sweeping changes. [Open a discussion on GitHub](https://github.com/SecureCorp-Mexico/SecureVu/discussions/new) for any large or architectural ideas.
...
https://hosted.weblate.org/projects/securevu-nvr/
