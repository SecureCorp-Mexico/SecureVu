...
- When running through the Home Assistant OS you may need to run the Full Access variant of the SecureVu Add-on with the _Protection mode_ switch disabled so that the coral can be accessed.
