...
The best way to integrate with Home Assistant is to use the [official integration](https://github.com/SecureCorp-Mexico/SecureVu-hass-integration).
...
If you are using Home Assistant Add-on, the URL should be one of the following depending on which Add-on variant you are using. Note that if you are using the Proxy Add-on, you should NOT point the integration at the proxy URL. Just enter the same URL used to access SecureVu directly from your network.
