...
Some presets of FFmpeg args are provided by default to make the configuration easier. All presets can be seen in [this file](https://github.com/SecureCorp-Mexico/SecureVu/blob/master/securevu/ffmpeg_presets.py).
