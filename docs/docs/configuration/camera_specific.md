...
[Some users have reported](https://www.reddit.com/r/securevu_nvr/comments/1hg4ze7/hikvision_security_settings) that newer Hikvision cameras require adjustments to the security settings:
...
According to [this discussion](https://github.com/SecureCorp-Mexico/SecureVu/issues/3235#issuecomment-1135876973), the http video streams seem to be the most reliable for Reolink.
