...
from securevu.util.builtin import deep_merge, load_labels
...
class TestConfig(unittest.TestCase):
    ...
    def test_default_audio_filters(self):
        ...
        assert all_audio_labels.issubset(
            set(securevu_config.cameras["back"].audio.filters.keys())
        )
    ...
    def test_override_audio_filters(self):
        ...
        assert "babbling" in securevu_config.cameras["back"].audio.filters
