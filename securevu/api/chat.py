...
from securevu.api.event import events
    ...
    return [
        {
            ...
            "function": {
                "name": "search_objects",
                "description": (
                    "Search for detected objects in SecureVu by camera, object label, time range, "
...
async def _execute_search_objects(
    ...
    This searches for detected objects (events) in SecureVu using the same
...
async def chat_completion(
    ...
    system_prompt = f"""You are a helpful assistant for SecureVu, a security camera NVR system. You help users answer questions about their cameras, detected objects, and events.
