...
Manages GenAI provider clients from SecureVu config. Configuration is read only
...
from securevu.config.camera.genai import GenAIRoleEnum
...
class GenAIClientManager:
    ...
    def update_config(self, config: SecureVuConfig) -> None:
        """Build role clients from current SecureVu config.genai.
