...
class MemryXDetector(DetectionApi):
    ...
    def __init__(self, detector_config):
        ...
        if self.memx_model_type == ModelTypeEnum.yologeneric:
            model_mapping = {
                (640, 640): (
                    "https://developer.memryx.com/example_files/2p0_securevu/yolov9_640.zip",
                    "yolov9_640",
                ),
                (320, 320): (
                    "https://developer.memryx.com/example_files/2p0_securevu/yolov9_320.zip",
                    "yolov9_320",
                ),
            }
            ...
            model_mapping = {
                (640, 640): (
                    "https://developer.memryx.com/example_files/2p0_securevu/yolonas_640.zip",
                    "yolonas_640",
                ),
                (320, 320): (
                    "https://developer.memryx.com/example_files/2p0_securevu/yolonas_320.zip",
                    "yolonas_320",
                ),
            }
            self.model_url, self.model_folder = model_mapping.get(
            ...
            self.model_url = (
                "https://developer.memryx.com/example_files/2p0_securevu/yolox.zip"
            )
            ...
            self.model_url = (
                "https://developer.memryx.com/example_files/2p0_securevu/ssd.zip"
            )
