...
class DebugReplayManager:
    ...
    def start(
        ...
        Args:
            ...
            securevu_config: Current SecureVu configuration
        ...
        with self._lock:
            return self._start_locked(
                source_camera, start_ts, end_ts, securevu_config, config_publisher
            )
    ...
    def _start_locked(
        ...
        if source_camera not in securevu_config.cameras:
        ...
        ffmpeg_cmd = [
            securevu_config.ffmpeg.ffmpeg_path,
            "-hide_banner",
            "-y",
            "-f",
            "concat",
    ...
    def stop(
        ...
        """
        with self._lock:
            self._stop_locked(securevu_config, config_publisher)
    ...
    def _stop_locked(
        ...
        if replay_name in securevu_config.cameras:
            config_publisher.publish_update(
