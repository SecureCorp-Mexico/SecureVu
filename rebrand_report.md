...
**Fecha:** 2026-03-26 13:02:35  
**Modo:** ✅ Aplicado  
**Módulo Python:** ✅ frigate/ → securevu/  
**Archivos modificados:** 1080  
**Reemplazos totales:** 8593  
...
### `.json` — 580 archivos · 4231 reemplazos
...
| `web/public/locales/de/config/global.json` | 23 | — |
...
| `web/public/locales/en/config/global.json` | 22 | — |
...
| `web/public/locales/fa/config/cameras.json` | 4 | — |
| `web/public/locales/fa/config/global.json` | 1 | — |
...
| `web/public/locales/fr/config/global.json` | 3 | — |
...
| `web/public/locales/fr/views/system.json` | 16 | — |
...
| `web/public/locales/hu/config/cameras.json` | 1 | — |
| `web/public/locales/hu/config/global.json` | 2 | — |
...
| `web/public/locales/hy/components/filter.json` | 3 | — |
...
| `web/public/locales/ko/components/auth.json` | 1 | — |
| `web/public/locales/ko/components/dialog.json` | 5 | — |
| `web/public/locales/ko/components/player.json` | 6 | — |
| `web/public/locales/ko/views/classificationModel.json` | 1 | — |
...
| `web/public/locales/ko/views/live.json` | 3 | — |
| `web/public/locales/ko/views/settings.json` | 19 | — |
...
| `web/public/locales/pt-BR/config/cameras.json` | 1 | — |
| `web/public/locales/pt-BR/config/global.json` | 2 | — |
...
| `web/public/locales/pt-BR/views/settings.json` | 56 | — |
| `web/public/locales/pt-BR/views/system.json` | 15 | — |
...
| `web/public/locales/sl/common.json` | 6 | — |
...
| `web/public/locales/sl/config/cameras.json` | 3 | — |
| `web/public/locales/sl/config/global.json` | 31 | — |
| `web/public/locales/sl/views/classificationModel.json` | 3 | — |
...
| `web/public/locales/sl/views/live.json` | 4 | — |
| `web/public/locales/sl/views/settings.json` | 64 | — |
| `web/public/locales/sl/views/system.json` | 16 | — |
| `web/public/locales/sq/common.json` | 1 | — |
...
| `web/public/locales/vi/components/dialog.json` | 5 | — |
| `web/public/locales/vi/components/filter.json` | 3 | — |
| `web/public/locales/vi/components/player.json` | 6 | — |
| `web/public/locales/vi/config/cameras.json` | 1 | — |
| `web/public/locales/vi/config/global.json` | 1 | — |
...
| `web/public/locales/yue-Hant/config/cameras.json` | 1 | — |
...
| `web/public/locales/zh-CN/config/cameras.json` | 4 | — |
| `web/public/locales/zh-CN/config/global.json` | 34 | — |
...
| `web/public/locales/zh-CN/views/settings.json` | 86 | — |
| `web/public/locales/zh-CN/views/system.json` | 16 | — |
...
### `.jsx` — 2 archivos · 2 reemplazos

| Archivo | Reemplazos | Renombrado a |
|---------|-----------|--------------|
| `docs/src/components/LanguageAlert/index.jsx` | 1 | — |
| `docs/src/components/ShmCalculator/index.jsx` | 1 | — |

### `.md` — 79 archivos · 1432 reemplazos
...
| `TRADEMARK.md` | 23 | — |
| `docs/README.md` | 1 | — |
| `docs/docs/configuration/advanced.md` | 47 | — |
...
| `docs/docs/configuration/cameras.md` | 11 | — |
| `docs/docs/configuration/custom_classification/object_classification.md` | 12 | — |
| `docs/docs/configuration/custom_classification/state_classification.md` | 9 | — |
| `docs/docs/configuration/face_recognition.md` | 17 | — |
| `docs/docs/configuration/ffmpeg_presets.md` | 7 | — |
| `docs/docs/configuration/genai/config.md` | 26 | — |
...
| `docs/docs/development/contributing.md` | 29 | — |
...
| `docs/docs/integrations/mqtt.md` | 80 | — |
| `docs/docs/integrations/plus.md` | 22 | — |
| `docs/docs/integrations/third_party_extensions.md` | 31 | — |
...
### `.py` — 232 archivos · 2050 reemplazos
...
| `securevu/api/app.py` | 55 | — |
| `securevu/api/auth.py` | 41 | — |
| `securevu/api/camera.py` | 33 | — |
| `securevu/api/chat.py` | 25 | — |
| `securevu/api/classification.py` | 45 | — |
...
| `securevu/api/fastapi_app.py` | 24 | — |
| `securevu/api/media.py` | 47 | — |
...
| `securevu/config/camera/profile.py` | 2 | — |
...
| `securevu/config/config.py` | 31 | — |
| `securevu/config/database.py` | 4 | — |
| `securevu/config/env.py` | 7 | — |
| `securevu/config/logger.py` | 3 | — |
| `securevu/config/mqtt.py` | 6 | — |
| `securevu/config/network.py` | 8 | — |
| `securevu/config/profile.py` | 2 | — |
| `securevu/config/profile_manager.py` | 8 | — |
...
| `securevu/detectors/plugins/axengine.py` | 7 | — |
...
| `securevu/output/preview.py` | 6 | — |
| `securevu/plus.py` | 2 | — |
| `securevu/ptz/autotrack.py` | 13 | — |
| `securevu/ptz/onvif.py` | 6 | — |
...
| `securevu/test/test_config.py` | 191 | — |
| `securevu/test/test_copy_yuv_to_position.py` | 1 | — |
| `securevu/test/test_env.py` | 35 | — |
| `securevu/test/test_ffmpeg_presets.py` | 39 | — |
| `securevu/test/test_file.py` | 1 | — |
...
| `securevu/test/test_profiles.py` | 19 | — |
| `securevu/test/test_proxy_auth.py` | 15 | — |
...
| `securevu/util/ffmpeg.py` | 1 | — |
| `securevu/util/file.py` | 3 | — |
...
| `securevu/util/services.py` | 9 | — |
| `securevu/video/detect.py` | 21 | — |
| `securevu/video/ffmpeg.py` | 14 | — |
| `securevu/watchdog.py` | 16 | — |
...
### `.ts` — 27 archivos · 139 reemplazos

| Archivo | Reemplazos | Renombrado a |
|---------|-----------|--------------|
| `docs/docusaurus.config.ts` | 21 | — |
| `docs/sidebars.ts` | 14 | — |
| `web/src/api/ws.ts` | 16 | — |
...
| `web/src/hooks/use-has-full-camera-access.ts` | 3 | — |
...
| `web/src/utils/configUtil.ts` | 6 | — |
| `web/src/utils/logUtil.ts` | 5 | — |

### `.tsx` — 127 archivos · 537 reemplazos
...
| `web/src/views/settings/CameraManagementView.tsx` | 5 | — |
| `web/src/views/settings/EnrichmentsSettingsView.tsx` | 3 | — |
| `web/src/views/settings/FrigatePlusSettingsView.tsx` | 64 | `web/src/views/settings/SecureVuPlusSettingsView.tsx` |
| `web/src/views/settings/Go2RtcStreamsSettingsView.tsx` | 3 | — |
...
| `web/src/views/settings/ProfilesView.tsx` | 3 | — |
...
### `.yml` — 13 archivos · 113 reemplazos
...
| `.github/workflows/pr_template_check.yml` | 2 | — |
| `.github/workflows/pull_request.yml` | 4 | — |
| `docker-compose.yml` | 4 | — |

### `Dockerfile` — 5 archivos · 27 reemplazos

| Archivo | Reemplazos | Renombrado a |
|---------|-----------|--------------|
| `docker/main/Dockerfile` | 22 | — |
